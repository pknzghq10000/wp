...
extract( shortcode_atts( array(
  ...
  <div class="ux_bg <?php echo $dark_text; ?> <?php echo $class; ?>" style="position:relative; <?php echo $background_color; ?> <?php echo $padding_row; ?>'">
...
function rowShortcode($atts, $content = null) {
  ...
  if($delay) {
	...
	$container = '<div class="row container '.$scroll.' '.$style.'" '.$scroll_html.' '.$delay_html.'>'.$content.'</div>';
	return $container;
} 
